      ...
      <div className="p-4">
          ...
          {variations.map((variation, index) => (
            <div
              ...
              className={`form-check py-3 ${
                index !== 2 ? 'border-bottom' : undefined
              }`}
            >
              <input
        ...
        {isProduct_in_cart ? (
          ...
          <button
            ...
            className="btn btn-lg d-flex align-items-center text-uppercase w-100 justify-content-center btn-warning"
          >
          ...
          <div className="p-4" style={{ backgroundColor: color }}>
            <div className="position-relative pdp-image-container">
              ...
              <button
                ...
                className="btn expand-btn position-absolute top-50 start-50 translate-middle btn-danger"
              >
        ...
        <div className="col-12 col-md-4 bg-light bg-gradient d-flex">
          <div className="d-flex flex-column w-100">
            ...
            <div className="p-4 border-top bg-grey d-flex flex-column h-100 w-100">
              ...
              >
                <UserInfo
                  userImg={user?.profile_image?.medium}
                  name={user?.name}
              ...
              <div className="d-flex flex-column mt-4">
                <div className="d-flex flex-wrap">
                  <p className="mb-2 me-3 fs-6 text-black">
                    <i className="fa-solid me-3 fs-5 fa-calendar-day"></i>
                    <span>Published : </span>
                    {moment(promoted_at).format('MMM Do YYYY')}
                  </p>
                  <p className="mb-2 me-3 fs-6 text-black">
                    <i className="fa-solid me-3 fs-5 fa-eye"></i>
                    <span>Views : </span>
                    {views}
                  </p>
                  <p className="mb-2 me-3 fs-6 text-black">
                    <i className="fa-solid me-3 fs-5 fa-download"></i>
                    <span>Downloads : </span>
                    {downloads}
                  </p>
                  <p className="mb-2 me-3 fs-6 text-black">
                    <i className="fa-sharp me-3 fa-solid fs-5 fa-thumbs-up"></i>
                    <span>Likes : </span>
                    {likes}
                  </p>
                  <p className="mb-2 me-3 fs-6 text-black">
                    <i className="fa-solid me-3 fs-5 fa-ruler-combined"></i>
                ...
                {exif && exif.name && (
                  <div className="mt-4">
                    <p className="mb-2 me-3 fs-6 text-black">
                      <i class="fa-solid me-3 fs-4 fa-camera"></i>Shot
                      With : {exif?.name}
                    </p>
                  </div>
                )}
          ...
          {tags && (
            <>
              ...
              <div className="d-flex flex-wrap my-3">
                {tags.map((tag) => {
                  return (
                    <span className="badge p-2 text-bg-secondary me-2 my-2">
                      {tag?.title}
                    </span>
                  );
                })}
